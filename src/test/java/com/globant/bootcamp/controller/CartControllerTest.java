...
@RunWith(SpringRunner.class) @SpringBootTest public class CartControllerTest {
	...
	@Test()
	public void whenAddAProductThatDoesntExistsThenThrowAnException() throws Exception {
		this.mockMvc.perform(post("/cart")
				.header("Authorization", this.token)
				.param("productId","60")
				.param("qty","1")
	...
	@Test()
	public void whenUpdateAProductThatDoesntExistsThenThrowAnException() throws Exception {
		this.mockMvc.perform(put("/cart")
				.header("Authorization", this.token)
				.param("productId","40")
				.param("qty","40")
